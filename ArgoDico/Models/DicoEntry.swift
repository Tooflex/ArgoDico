...
#if DEBUG
let testDataItems = [
    DicoEntry(id: "1", word: "Wesh", wordDefinitions: ["Salut ou provocation appartenant au vocabulaire des jeunes. \"Wesh\" est dérivé de l'arabe \"wesh rak\" (comment vas-tu ?)."], illustrationImage: URL(fileURLWithPath: "https://cdn.radiofrance.fr/s3/cruiser-production/2018/02/dd1a0515-1d56-4b82-8a69-c2420fc2eb62/1200x680_wesh.jpg"), createdBy: "Tooflex", createdOn: Date.init()),
